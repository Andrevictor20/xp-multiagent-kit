...
- **Telemetria de Tokens em 3 Camadas & Pre-Flight Gate:** Monitore ativamente a Janela de Mensagem, a Janela Móvel de 5 Horas e a Cota Semanal via `xp-tokens` (<usado>/<total>). Se qualquer camada estiver crítica (>80% em 5h/Semana ou >70% em Contexto), alerte o usuário antes de iniciar tarefas substantivas. Se o usuário insistir em prosseguir, opere em **Modo Cirúrgico Atômico**: execute estritamente o que for cabível no orçamento restante, garantindo um checkpoint completo, testado e estável, sem deixar trabalho pela metade ([token-budget-tracker](file:///home/andrevmp/Downloads/xp-multiagent-kit/.agents/skills/token-budget-tracker/SKILL.md)).
